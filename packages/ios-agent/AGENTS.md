...
produced PNG under a `CODEC_JPEG` stamp until that argument was added. Set on the agent process. The codec is signalled per frame in the TFFE envelope (byte5 bit0).
