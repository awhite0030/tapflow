 ...
 * nothing after it. Measured with clack 1.7 under a pty: exit 0, never settled. A setup prompt reached
 * this way exits the process without a banner, which is worse than not asking.
 */
